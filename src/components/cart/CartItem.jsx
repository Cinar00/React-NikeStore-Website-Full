    ...
    <>
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          <div
            className={`bg-gradient-to-b ${color} ${shadow} relative rounded p-3 hover:scale-105 transition-all duration-500 ease-in-out grid items-center`}
          >
            <img
              src={img}
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              ...
              className="bg-theme-cart cursor-pointer rounded p-1 lg:p-0.5 grid items-center justify-items-center active:scale-90"
            >
